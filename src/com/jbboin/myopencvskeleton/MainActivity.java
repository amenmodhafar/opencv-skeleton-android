package com.jbboin.myopencvskeleton;
...
public class MainActivity extends Activity {
	...
	private int PreviewSizeWidthWanted = 640;
	private int PreviewSizeHeightWanted = 480;
	
	private int PreviewSizeWidth, PreviewSizeHeight;

	static{
		System.loadLibrary("opencv_java");
		System.loadLibrary("MyOpenCVSkeleton");
	}
	...
	public void onCreate(Bundle savedInstanceState){
		...
		List<Size> lPreview = mCamera.getParameters().getSupportedPreviewSizes();
		...
		CameraPreview camPreview = new CameraPreview(PreviewSizeWidth, PreviewSizeHeight, mImageView, mCamera);
